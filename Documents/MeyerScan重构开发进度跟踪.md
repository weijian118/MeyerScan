...
| 2026-07-23 | 确认设备采集方案：持续取 B 包，单图立即解密，整组开灯才自动曝光，最多两条无回包命令且间隔 5 ms，慢速后处理使用副本和有界队列 |
| 2026-07-23 | 确认 MyScan 5/5H/6 使用独立采集 Profile；MyScan 6 暂以 MyScan 5 25 帧参数值初始化 |
