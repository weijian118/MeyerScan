...
[![Version](https://img.shields.io/badge/version-1.1.0-blue.svg)](https://github.com/weijian118/MeyerScan)
...
Database 使用 Qt 是当前设计的一部分，不需要去 Qt 化。后续如果要替换 Qt SQL，也应保持 `IDatabase` 接口不变，由 DLL 内部替换实现。
